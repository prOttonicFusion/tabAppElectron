...
document.getElementById('initial-balance-input-label').innerHTML = translation['initial-balance-input-label']
document.getElementById('accept-user-button').innerHTML = translation['accept-button']
